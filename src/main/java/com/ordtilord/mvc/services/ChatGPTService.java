...
import com.ordtilord.mvc.models.ChatGPTRequest;
import com.ordtilord.mvc.models.ChatGPTResponse;
...
public class ChatGPTService {
    ...
    @org.springframework.beans.factory.annotation.Value("${OPEN_AI_URL}")
